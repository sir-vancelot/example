...
/**
 * A [BatmanEncryptedRepository] is used to link a parent [BatmanEncryptedDBDatastore] to its children [BatmanEncryptedDBDatastores][BatmanEncryptedDBDatastore]
 * that reference it via a [database][android.database.sqlite.SQLiteDatabase] foreign key.
 */
abstract class BatmanEncryptedRepository<ParentModel : BatmanModel, ParentDBDatastore : BatmanEncryptedDBDatastore<ParentModel>>(protected val parentDBDatastore: ParentDBDatastore) {
    /**
